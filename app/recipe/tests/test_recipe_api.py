...
def create_recipe(user, ** params):
    """Create and return a sample of recipe."""
    defaults = {
        'title': 'Sample recipe title',
        'time_minutes': 22,
        'price': Decimal('5.25'),
        'description': 'Sample description',
        'link': 'http://wxample.com/recipe.pdf'
    }
...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_recipe_list_limited_to_user(self):
        """Test list if recipes is limited to autenticated user."""
    ...
    def test_update_yser_returns_error(self):
